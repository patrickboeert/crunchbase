function obj = set_nbafr(obj, save, varargin)
% NBAFR  nbafr: total number of funding rounds people participated
% in
%
% DESCR
...
n     = 3;
name  = 'nbafr';
descr = 'people --> nbafr: total number of funding rounds people participated in';
input = {'pe_ninv'};
