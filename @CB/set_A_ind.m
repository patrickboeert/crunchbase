function obj = set_A_ind(obj, save, varargin)
% A_perma   index value of company, people or financial institutions object
% in entity data

%% parameters
n     = 37;
name  = 'A_ind';
descr = 'A_ind: index value of company, people or financial institutions object in entity data';
input = {};
...
A_ind = [ (1:obj.nobs(1))' ; (1:obj.nobs(2))' ; (1:obj.nobs(3))' ]; 
