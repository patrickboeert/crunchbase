function obj = set_A_ispe(obj, save, varargin)
% A_ISPE   logical value that investor is people object

%% parameters
n     = 39;
name  = 'A_ispe';
descr = 'A_ispe: logical value that investor is people object';
input = {};
...
A_ispe = [ zeros(obj.nobs(1),1) ; ones(obj.nobs(2),1) ; zeros(obj.nobs(3),1) ];
A_ispe = logical(A_ispe);
