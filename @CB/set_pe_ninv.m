function obj = set_pe_ninv(obj, save, varargin)
% PE_NINV  pe_ninv: number of investments for each person
%
% DESCR
...
n     = 1;
name  = 'pe_ninv';
descr = 'people --> pe_ninv: # of funding rounds by person';
input = {'people_investments'};
...
pe_ninv = zeros(size(investments));
for pe = 1:length(investments)
  pe_ninv(pe) = length(investments{pe});
end
