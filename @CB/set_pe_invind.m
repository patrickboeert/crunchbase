function obj = set_pe_invind(obj, save, varargin)
% PE_INVIND   map: people index to investor index

%% parameters
n     = 42;
name  = 'pe_invind';
descr = 'pe --> pe_invind: map people index to investor index';
input = {'A_ispe'};
