function obj = set_com_fr_dtcomfr(obj, save, varargin)
% COM_FR_DTCOMFR  date (year, month, day) of company funding
% rounds
%
% DESCR
...
n     = 26;
name  = 'com_fr_dtcomfr';
descr = 'com --> fr --> com_fr_dtcomfr: date (year, month, day) of company funding round';
...
com_fr_dtcomfr = cell(size(comfr));   % preallocate
...
for com = 1:length(comfr)                      % com
  for fr = 1:length(comfr{com})                 % com fr
    ...
    for dt = [1,2,3]
      ...
      switch dt
        case 1
          com_fr_dtcomfr{com}{fr,dt} = comfr{com}(fr).funded_year;
        case 2
          com_fr_dtcomfr{com}{fr,dt} = comfr{com}(fr).funded_month;
        case 3
          com_fr_dtcomfr{com}{fr,dt} = comfr{com}(fr).funded_day;
      end
