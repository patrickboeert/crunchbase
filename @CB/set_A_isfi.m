function obj = set_A_isfi(obj, save, varargin)
% A_ISFI   logical value that investor is financial organization object

%% parameters
n     = 40;
name  = 'A_isfi';
descr = 'A_isfi: logical value that investor is financial organization object';
input = {};
...
A_isfi = [ zeros(obj.nobs(1),1) ; zeros(obj.nobs(2),1) ; ones(obj.nobs(3),1) ];
A_isfi = logical(A_isfi);
