function obj = set_co_invind(obj, save, varargin)
% CO_INVIND   map: people index to investor index

%% parameters
n     = 43;
name  = 'co_invind';
descr = 'co --> co_invind: map company index to investor index';
input = {'A_isco'};
